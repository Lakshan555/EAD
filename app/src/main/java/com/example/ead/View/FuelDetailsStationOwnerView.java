                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (response.get("isSuccessful").equals(true)) {
                                ...
                                String d = fd.getJSONObject(0).getString("quantity");
                                String sd = fd.getJSONObject(1).getString("quantity");
                                String p92 = fd.getJSONObject(2).getString("quantity");
                                String p95 = fd.getJSONObject(3).getString("quantity");
